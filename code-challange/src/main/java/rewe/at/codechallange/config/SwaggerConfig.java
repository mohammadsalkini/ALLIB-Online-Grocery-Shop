package rewe.at.codechallange.config;
...
public class SwaggerConfig {
    public static final Contact DEFAULT_CONTACT = new Contact("Mohammad Alsalkini",
            "", "eng.salkini@hotmail.com");

    public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("ALLIB Online Grocery Shop", "Ecom Platform",
